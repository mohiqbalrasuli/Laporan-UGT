                ...
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="laporanKe" id="radioJumadalTsaniyah"
                                    value="Jumadal Tsaniyah">
                ...
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="mengajar_balighah" id="balighah_ya"
                                    value="Ya">
                ...
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="waktu_kegiatan[]" id="waktu_siang"
                                    value="Siang">
                                <label class="form-check-label" for="waktu_siang">Siang</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="waktu_kegiatan[]" id="waktu_malam"
                                    value="Malam">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="sifat_kegiatan" id="sifat_lanjut"
                                    value="Melanjutkan">
                ...
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="bepergian_tidak" name="gt_bepergian"
                                    value="Tidak">
                ...
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="ijin_1" name="surat_ijin_dipakai"
                                    value="1">
                                <label class="form-check-label" for="ijin_1">1 Kali</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="ijin_2" name="surat_ijin_dipakai"
                                    value="2">
                                <label class="form-check-label" for="ijin_2">2 Kali</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="ijin_3" name="surat_ijin_dipakai"
                                    value="3">
                                <label class="form-check-label" for="ijin_3">3 Kali</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="ijin_4" name="surat_ijin_dipakai"
                                    value="4">
                                <label class="form-check-label" for="ijin_4">4 Kali</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="ijin_5" name="surat_ijin_dipakai"
                                    value="5">
                ...
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh1" name="jumlah_bisyaroh1">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh2" name="jumlah_bisyaroh2">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh3" name="jumlah_bisyaroh3">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh4" name="jumlah_bisyaroh4">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh5" name="jumlah_bisyaroh5">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh6" name="jumlah_bisyaroh6">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh7" name="jumlah_bisyaroh7">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh8" name="jumlah_bisyaroh8">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_bisyaroh9" name="jumlah_bisyaroh9">
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="bisyaroh10_tidak" name="bisyaroh10"
                                    value="Tidak">
