                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="mb-3">
                                <label for="AlamatMadrasah" class="form-label">Alamat
                                    Madrasah</label>
                                <textarea class="form-control" id="AlamatMadrasah"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="NameKepalaMadrasah" class="form-label">Nama Kepala
                                    Madrasah</label>
                            ...
                            <div class="mb-3">
                                <div class="mb-0">Jenis Kelamin Murid</label>
                                    <div class="form-chek">
                                        ...
                                        <label class="form-check-label" for="JKmurid3">Banin -
                                            Banat</label><br>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="jml1pekan" class="form-label">Jumlah Hari Mengajar
                                        1 Pekan</label>
                                    <input type="number" class="form-control" id="jml1pekan"
                                        aria-describedby="jml1pekan">
                                ...
                                <div class="mb-3">
                                    <label for="jmljam1pekan" class="form-label">Jumlah Jam
                                        Mengajar 1 Pekan</label>
                                    <input type="number" class="form-control" id="jmljam1pekan"
                                        aria-describedby="jmljam1pekan">
                                    <div id="jmljam1pekan" style="font-size: 10px" class="form-text fst-italic">(* Hitung
                                        Jumlah
                                ...
                                <div class="mb-3">
                                    <label for="jml1bulan" class="form-label">Jumlah Hari Mengajar
                                        1 Bulan</label>
                                    <input type="number" class="form-control" id="jml1bulan"
                                        aria-describedby="jml1bulan">
                                ...
                                <div class="mb-3">
                                    <label for="jmljam1bulan" class="form-label">Jumlah Jam
                                        Mengajar 1 Bulan</label>
                                    <input type="number" class="form-control" id="jmljam1bulan"
                                        aria-describedby="jmljam1bulan">
                                    <div id="jmljam1bulan" style="font-size: 10px" class="form-text fst-italic">(* Hitung
                                        Jumlah
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3" id="alasantidakmengajar"
                        ...
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="jumlahjamsakit" class="form-label">Jumlah Jam
                                            Sakit</label>
                        ...
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="jumlahjampulang" class="form-label">Jumlah Jam
                                            Pulang</label>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <div class="mb-3">
                                    <div class="mb-3">
                                        <label for="jumlahlain" class="form-label">Jumlah Hari
                                            lain</label>
                                        <input type="number" class="form-control" id="jumlahlain"
                                            aria-describedby="jumlahlain">
                                    </div>
                                    <div class="mb-3">
                                        <label for="jumlahjamlain" class="form-label">Jumlah Jam
                                            lain</label>
                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="kegiatan1">Mengajar
                                            Al-Qur'an
                                            Bit-Tartil</label><br>

                                        <input type="checkbox" class="form-check-input" id="kegiatan2">
                                        <label class="form-check-label" for="kegiatan2">Mengajar
                                            Kitabiyah</label><br>

                                        <input type="checkbox" class="form-check-input" id="kegiatan3">
                                        <label class="form-check-label" for="kegiatan3">Menjadi
                                            Imam Shalat
                                            Rawatib</label><br>

                                        <input type="checkbox" class="form-check-input" id="kegiatan4">
                                        <label class="form-check-label" for="kegiatan4">Menjadi
                                            Imam Shalat
                                            Jum'at</label><br>

                                        <input type="checkbox" class="form-check-input" id="kegiatan5">
                                        <label class="form-check-label" for="kegiatan5">Menjadi
                                            Bilal Shalat
                                            Jum'at</label><br>

                                        <input type="checkbox" class="form-check-input" id="kegiatan6">
                                        <label class="form-check-label" for="kegiatan6">Kegiatan
                                            Kemasyarakatan</label><br>

                                        <input type="checkbox" class="form-check-input" id="kegiatan7">
                                        <label class="form-check-label" for="kegiatan7">Tidak
                                            Ada</label><br>
                        ...
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="sebanyak"
                                        aria-describedby="sebanyak">
                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <div class="mb-3">
                                    <label for="pemecahan" class="form-label">Langkah Pemecahan
                                        Kendala</label>
                                    <input type="text" class="form-control" id="pemecahan"
                                        aria-describedby="descPemecahan">
                                ...
                                <div class="mb-3">
                                    <label for="tugasBaru" class="form-label">Tugas Baru Dari
                                        KM/PJGT</label>
                                    <input type="text" class="form-control" id="tugasBaru"
                                        aria-describedby="descTugasBaru">
